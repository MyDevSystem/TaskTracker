...
public class Task {
    ...
    public Task(UUID id, String title, String description, LocalDateTime updated, LocalDateTime created, TaskPriority priority, TaskStatus status, LocalDateTime dueDate) {
